...
/** Resolves an imported image to its URL string. */
const toSrc = (img: StaticImageData | string): string => (typeof img === "string" ? img : img.src);

/** NJ government banner header with state seal and official site link. */
      ...
      <div className="nj-banner__header">
        <div className="grid-container">
          <div className="nj-banner__inner">
            <div>
              <img src={toSrc(njStateSeal)} className="nj-banner__header-seal" alt="NJ flag" />
            </div>
