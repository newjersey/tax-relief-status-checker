...
export const LandingPageFaq = (props: { headingLevel: HeadingLevel }) => {
  const faqContent: AccordionItemProps[] = [
    {
      title:
        "When can I expect my paper application to show up in this online tool?",
      content: (
        <p>Placeholder</p>
      ),
      expanded: false,
    ...
    {
      title:
        "Why are 2022 and 2023 missing from the tax year selection?",
      content: (
        <p>
          Placeholder3
        </p>
    ...
    {
      title: "My application has been sitting in processing longer than expected, who should I reach out to?",
      content: (
        <p>
          Placeholder5
        </p>
